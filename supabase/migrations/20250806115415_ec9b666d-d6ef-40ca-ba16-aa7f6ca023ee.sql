-- Phase 1 (Fixed): Implement Proper RLS Policies for Data Protection
...
-- Note: loan_interest_profits is a view, RLS cannot be enabled on views

-- MEMBERS table policies - admins can manage, authenticated users can view
...
CREATE POLICY "Treasurers and admins can manage loan repayments"
  ON public.loan_repayments FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Treasurers and admins can manage budgets"
  ON public.budgets FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Treasurers and admins can manage expense categories"
  ON public.expense_categories FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Meeting managers can manage meetings"
  ON public.meetings FOR INSERT, UPDATE, DELETE
  TO authenticated
...
CREATE POLICY "Meeting managers can manage attendance"
  ON public.meeting_attendance FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'secretary'::app_role, 'chairperson'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'secretary'::app_role, 'chairperson'::app_role]));
...
CREATE POLICY "Treasurers and admins can manage dividend declarations"
  ON public.dividend_declarations FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Treasurers and admins can manage member dividends"
  ON public.member_dividends FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Treasurers and admins can manage contribution targets"
  ON public.contribution_targets FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));
...
CREATE POLICY "Admins can manage notification templates"
  ON public.notification_templates FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_role(auth.uid(), 'admin'::app_role))
  WITH CHECK (public.has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can manage notification campaigns"
  ON public.notification_campaigns FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_role(auth.uid(), 'admin'::app_role))
  WITH CHECK (public.has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Admins can manage communication preferences"
  ON public.member_communication_preferences FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_role(auth.uid(), 'admin'::app_role))
  WITH CHECK (public.has_role(auth.uid(), 'admin'::app_role));
...
CREATE POLICY "Treasurers and admins can manage financial reports"
  ON public.financial_reports FOR INSERT, UPDATE, DELETE
  TO authenticated
  USING (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]))
  WITH CHECK (public.has_any_role(auth.uid(), ARRAY['admin'::app_role, 'treasurer'::app_role]));